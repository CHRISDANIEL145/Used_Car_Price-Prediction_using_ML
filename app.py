...
model = joblib.load('D:\AI Project\Car_Price Prediction\car_price_prediction_model.pkl')
label_encoders = joblib.load('D:\AI Project\Car_Price Prediction\label_encoders.pkl')
scalers = joblib.load('D:\AI Project\Car_Price Prediction\scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv('D:\AI Project\Car_Price Prediction\car_cleaned_dataset_Raw.csv')
...
result_background_color = "black"  # Cosmic latte or beige color
